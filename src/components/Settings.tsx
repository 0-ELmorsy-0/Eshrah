...
export function Settings() {
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="p-6 bg-bg-card border border-white/5 rounded-3xl">
        <h2 className="text-xl font-bold text-white mb-2">إعدادات النظام</h2>
        <p className="text-slate-400">إدارة إعدادات النظام والبيانات</p>
      </div>

      {/* Data Management Section */}
      <div className="p-6 bg-bg-card border border-white/5 rounded-3xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Reload Data Card */}
          <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl flex flex-col items-center text-center gap-4 hover:border-primary-500/30 transition-colors">
            <div className="w-14 h-14 rounded-full bg-primary-500/10 text-primary-500 flex items-center justify-center">
              <RefreshCw className="w-6 h-6" />
            </div>
            <div>
              <h4 className="text-white font-bold text-lg mb-1">إعادة تحميل البيانات</h4>
              <p className="text-slate-400 text-sm">استعادة البيانات التجريبية</p>
            </div>
          ...
          {/* Delete Data Card */}
          <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl flex flex-col items-center text-center gap-4 hover:border-red-500/30 transition-colors">
            <div className="w-14 h-14 rounded-full bg-red-500/10 text-red-500 flex items-center justify-center">
              <Trash2 className="w-6 h-6" />
            </div>
            <div>
              <h4 className="text-white font-bold text-lg mb-1">مسح البيانات التجريبية</h4>
              <p className="text-slate-400 text-sm">حذف جميع البيانات والبدء من جديد</p>
            </div>
      ...
      <div className="p-6 bg-bg-card border border-white/5 rounded-3xl space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl flex flex-col items-end gap-1">
            <span className="text-slate-400 text-sm">اسم النظام</span>
            <span className="text-white font-bold text-lg">إشرحــ طب</span>
          </div>
          <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl flex flex-col items-end gap-1">
            <span className="text-slate-400 text-sm">الإصدار</span>
            <span className="text-white font-bold text-lg">1.0.0</span>
          </div>
          <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl flex flex-col items-end gap-1">
            <span className="text-slate-400 text-sm">قاعدة البيانات</span>
            <span className="text-white font-bold text-lg">Convex</span>
          </div>
          <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl flex flex-col items-end gap-1">
            <span className="text-slate-400 text-sm">اللغة</span>
            <span className="text-white font-bold text-lg">العربية (RTL)</span>
          </div>
        </div>
      </div>
    </div>
